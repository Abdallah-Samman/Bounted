...
<body>
    ...
    <div class="home_content">
        <div class="payments">
            <!--PAYMENT SERVICES-->
            <div class="telecom"><i class="fas fa-wifi"></i>
        <p>Telecom & Internet</p></div>
            <div class="electricity_recharge"><i class="fas fa-plug"></i>
        <p>Electricity Recharge Card</p></div>
            <div class="electricity_bills"><i class="fas fa-plug"></i>   <p>Electricity Bills</p></div>
            <div class="water"><i class="fas fa-faucet"></i>   <p>Water</p></div>
            <div class="gas"><i  class="fas fa-gas-pump"></i>   <p>Gas</p></div>
            <div class="donations"><i class="fas fa-hands-helping"></i>   <p>Donations</p></div>
        </div>
    </div>
