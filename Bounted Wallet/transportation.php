...
<body>
    ...
    <div class="transportation">
            <!--PAYMENT SERVICES-->
            <div class="train"><i class="fas fa-train"></i>
        <p>Train</p></div>
            <div class=" careem"><i class="fas fa-car"></i>
        <p>Careem</p></div>
            <div class="metro"><i class="fas fa-subway"></i>  <p>Metro</p></div>
            <div class="bus"><i class="fas fa-bus-alt"></i>  <p>Bus</p></div>
            <div class="uber"><i class="fab fa-uber"></i> <p>Uber</p></div>
            <div class="swvl"><i class="fas fa-bus"></i>   <p>Swvl</p></div>
        </div>
    </div>
</body>
